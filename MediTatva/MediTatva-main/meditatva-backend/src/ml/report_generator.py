    ...
    def generate_report(self, screening_responses: Dict[str, Any], 
        ...
        report = {
            ...
            'screening_data': {
                ...
                'responses_count': len(screening_responses),
                'primary_emotion': emotional_profile.get('primary_emotion', 'unknown'),
                'emotional_diversity': emotional_profile.get('emotional_diversity', 0)
            }
        }
